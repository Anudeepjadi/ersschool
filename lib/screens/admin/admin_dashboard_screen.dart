      ...
      child: ListView(
        ...
        children: [
          ...
          Theme(
            data: Theme.of(context).copyWith(dividerColor: Colors.transparent),
            child: ExpansionTile(
              leading: Icon(Icons.settings_suggest_outlined, color: Color(0xFF757897)),
              title: Text("Configuration".tr, style: TextStyle(
