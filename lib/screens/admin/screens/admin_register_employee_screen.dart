...
class AdminRegisterEmployeeScreen extends StatefulWidget {
  ...
  const AdminRegisterEmployeeScreen(
      {super.key,
  ...
  @override
  State<AdminRegisterEmployeeScreen> createState() =>
      _AdminRegisterEmployeeScreenState();
}
...
class _AdminRegisterEmployeeScreenState
  ...
  void initState() {
    ...
    if (widget.employee == null) {
      ...
      if (widget.staffType == 'Teacher') {
        ...
        defaultDept = 'Attender/Aaya';
      }

      // IDE Analyzer sync forced
      _formData = {
        'status': 'Active',
      ...
      _formData['department'] ??= "Teaching";
      _formData['employee_type'] ??= "Full Time";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AdminAppBar(
        title:
            widget.isEditMode ? "Edit Employee".tr : "Register New Employee".tr,
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text("Employee Saved!".tr),
                  ...
                  _buildFormCard(
                    ...
                    children: [
                      ...
                      _buildTextField("Employee Code",
                          hint: "Enter Code",
                          initialValue: _formData['employeeCode'],
                          onChanged: (v) => _formData['employeeCode'] = v),
                      _buildDropdownField(
                          "Gender", _formData['gender'] ?? "Male",
                          items: ["Male", "Female"],
                          onChanged: (v) =>
                              setState(() => _formData['gender'] = v)),
                      _buildTextField("Aadhaar Number",
                          initialValue: _formData['aadhaar'],
                          onChanged: (v) => _formData['aadhaar'] = v),
                    ],
                  ),
                  _buildFormCard(
                    ...
                    children: [
                      ...
                      _buildTextField("Primary Mobile *",
                          initialValue: _formData['phone']
                              ?.toString()
                              .replaceAll(',', ''),
                          onChanged: (v) => _formData['phone'] = v),
                      _buildTextField("Primary Email",
                          initialValue: _formData['email'],
                          onChanged: (v) => _formData['email'] = v),
                      _buildTextField("Secondary Mobile",
                          initialValue: _formData['secondary_mobile'],
                          onChanged: (v) => _formData['secondary_mobile'] = v),
                  ...
                  _buildFormCard(
                    ...
                    children: [
                      _buildDropdownField("Branch",
                          ...
                          onChanged: (v) =>
                              setState(() => _formData['school'] = v)),
                      _buildDropdownField(
                          "Department", _formData['department'] ?? "Teaching",
                          items: [
                            "Teaching",
                            "Administration",
                            "Attender/Aaya",
                          ...
                          onChanged: (v) =>
                              setState(() => _formData['department'] = v)),
                      _buildTextField("Designation / Subject",
                          initialValue: _formData['subject'],
                          onChanged: (v) => _formData['subject'] = v),
                      _buildDropdownField("Employee Type",
                          _formData['employee_type'] ?? "Full Time",
                          items: ["Full Time", "Part Time", "Contract"],
                          onChanged: (v) =>
                              setState(() => _formData['employee_type'] = v)),
                      _buildTextField("Experience",
                          hint: "e.g., 5 years",
                          initialValue: _formData['experience'],
                          onChanged: (v) => _formData['experience'] = v),
                      _buildTextField("Date of Join",
                          hint: "dd/mm/yyyy",
                          icon: Icons.calendar_month,
                          initialValue: _formData['date_of_join'],
                          onTap: () => _selectDate('date_of_join')),
                      Padding(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            widget.isEditMode
                ? "Update Employee Photo".tr
                : "Upload Employee Photo".tr,
            style: TextStyle(
                fontSize: 14,
