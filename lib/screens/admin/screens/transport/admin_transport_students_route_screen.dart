...
class AdminTransportStudentsRouteScreen extends StatefulWidget {
  ...
  @override
  State<AdminTransportStudentsRouteScreen> createState() => _AdminTransportStudentsRouteScreenState();
}
...
class _AdminTransportStudentsRouteScreenState extends State<AdminTransportStudentsRouteScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AdminAppBar(title: "Students By Route", subtitle: "Manage your transport students by route"),
