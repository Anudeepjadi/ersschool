...
class _AdminConfigDetailScreenState extends State<AdminConfigDetailScreen> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            TextField(decoration: InputDecoration(labelText: "Description/Value")),
          ],
        ),
        actions: [
  ...
  void _deleteItem(int index) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text("Delete Entry".tr, style: TextStyle(color: Colors.red)),
        content: Text("Are you sure you want to remove this configuration entry?".tr),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: Text("Cancel".tr)),
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.pop(ctx);
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Entry deleted.".tr)));
            },
        ...
        children: [
          ...
          Expanded(
            child: _items.isEmpty
                ? Center(child: Text("No ${widget.title.toLowerCase()} found", style: TextStyle(color: Colors.grey)))
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text(item['name'], style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF1E2875))),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(item['details'], style: TextStyle(fontSize: 12, color: Colors.grey)),
                              SizedBox(height: 4),
                              Container(
                          ...
                          trailing: Row(
                            ...
                            children: [
                              IconButton(
                                icon: Icon(Icons.edit_note, color: Colors.blue, size: 24),
